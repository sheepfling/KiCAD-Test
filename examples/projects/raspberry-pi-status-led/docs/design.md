...
The Python example is at examples/projects/raspberry-pi-status-led/firmware/status_led.py. It uses GPIO
Zero's BCM numbering and blinks GPIO17.

Raspberry Pi GPIO is a 3.3 V logic domain. Do not connect 5 V to GPIO17, and do not
omit the series resistor. Check the official [Raspberry Pi GPIO documentation](https://www.raspberrypi.com/documentation/computers/raspberry-pi.html)
