...
- [Native project](kicad/status-indicator-wiring.kicad_pro): open with the exact selected KiCad version.
- [Test contract](tests/contract.json): independent native expectations.

From the repository root, run `python -B -m tools.ci --project status-indicator-wiring`.
